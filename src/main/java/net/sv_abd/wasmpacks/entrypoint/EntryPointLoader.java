 ...
 *
 * The optional {@code args} array declares the string arguments this function
 * accepts (by name, in order). At call-time the caller must supply exactly that
 * many string values; the wasm module reads them via the {@code get_arg} host
 * import.
 */
